...
"book_extraction": [
  ...
  "My wisdom teeth are hurting so much, I need them to get removed as soon as possible",
  "Need to remove my tooth please",
  "My teeth is rotting and needs to be removed",
  "I need a tooth removal this week",
  "I need to take out a couple of my teeth",
  "Do you guys do teeth removal",
  "My teeth needs to get replaced as soon as possible",
  "I'd like to schedule a tooth extraction.",
    ...
    "I need urgent tooth extraction.",
    "Is it possible to remove my tooth today?",
    ...
    "I need to book an emergency tooth removal.",
    ...
    "How soon can I get an extraction done?",
